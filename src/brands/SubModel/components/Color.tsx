...
const Icon: IconType = memo(({ size = '1em', style, ...rest }) => {
  ...
  return (
    ...
    >
      ...
      />
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse" id={a.id} x1="0" x2="24" y1="14.5" y2="14.5">
          <stop stopColor="#E560FC" />
          <stop offset="1" stopColor="#673CFF" />
        </linearGradient>
        <linearGradient gradientUnits="userSpaceOnUse" id={b.id} x1="0" x2="24" y1="14.5" y2="14.5">
          <stop stopColor="#E560FC" />
          <stop offset="1" stopColor="#673CFF" />
        </linearGradient>
        <linearGradient gradientUnits="userSpaceOnUse" id={c.id} x1=".5" x2="23" y1="8" y2="7.5">
          <stop stopColor="#0ED1FC" />
          <stop offset="1" stopColor="#3171F5" />
        </linearGradient>
      </defs>
    </svg>
  );
